...
const MiningMinralsResource = () => {
  ...
  return (
    <div className="bg-gray-100 p-6 my-10 md:mx-4 rounded-lg shadow-md">
      ...
      <div className="flex justify-center flex-wrap gap-4">
        {Resources.map((data) => (
          <div
            key={data.id}
            className="bg-[#EAE1D1] shadow-lg p-6 rounded-lg md:w-1/2 lg:w-1/3 max-w-[350px] cursor-pointer transform transition-transform duration-300 hover:scale-105"
          >
            <img
              src={data.image}
