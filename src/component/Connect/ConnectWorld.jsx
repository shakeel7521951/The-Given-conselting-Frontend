...
import gts from '../../assets/import&export/gts.jpg';
export default function ConnectWorld() {
  ...
  return (
    <div className="min-h-[80vh] bg-gray-50 rounded-lg my-10 p-8 w-full shadow-md">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        {services.map(({ id, category, icon, description, details }) => (
          <div
            key={id}
            className="bg-[#EAE1D1] shadow-md rounded-lg overflow-hidden hover:shadow-lg transform transition-all duration-300 hover:scale-105"
          >
