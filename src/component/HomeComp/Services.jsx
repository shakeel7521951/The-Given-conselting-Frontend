...
const Services = () => {
  ...
  return (
    <section className="bg-white rounded-lg my-16 pt-6 pb-10 px-6">
      ...
      <main className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {ourServices?.map((item) => {
          return (
            <div
              key={item?.id}
              className="bg-[#EAE1D1] shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-2xl cursor-pointer py-5"
