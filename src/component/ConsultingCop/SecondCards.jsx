...
const SecondCards = () => {
  return (
    <>
      {/* 2 CARD SECTION*/}
      <div className="flex flex-wrap items-center justify-center h-auto px-6 sm:text-1xl my-32 md:my-8 mb-12">
        {/* Left Side - Image */}
        ...
        <div className="w-full md:w-1/2 text-center md:text-left md:text-2xl">
          ...
          <h1 className="text-4xl font-bold mb-4 sm:mx-5 md:text-2xl">
            Navigating the Evolving Busi...
          </h1>
          <p className="text-lg text-gray-600 mb-6 text-justify px-7">
          ...
          <button className="px-6 sm:mx-5 py-3 bg-[#F2FF05] text-black rounded-full hover:bg-[#f1fa43] transition">
            Get it Touch
          </button>
        </div>
      </div>
